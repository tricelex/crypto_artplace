...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => (
  <div className='flex flex-col p-4 m-4 bg-white border min-w-190 minlg:min-w-240 dark:bg-nft-gray-3 dark:border-nft-black-3 border-nft-gray-1 rounded-3xl '>
