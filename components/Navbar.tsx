...
const MenuItems = ({ isMobile, active, setActive }) => {
  ...
  return (
    <ul className={`flex-row list-none flexCenter ${isMobile && 'flex-col h-full'}`}>
...
const Navbar = () => {
  ...
  return (
    <nav className='fixed z-10 flex-row w-full p-4 bg-white border-b flexBetween dark:bg-nft-dark dark:border-nft-black-1 border-nft-gray-1'>
      <div className='flex flex-1 flex-r'>
        <Link href='/'>
          <div className='cursor-pointer flexCenter md:hidden' onClick={() => {}}>
